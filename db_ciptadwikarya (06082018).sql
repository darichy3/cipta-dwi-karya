...
--
-- Host: 127.0.0.1
-- Generation Time: 06 Agu 2018 pada 15.08
...
(1, 'Piutang', 'keterangan disini'),
(2, 'Penjualan', 'Keterangan disini'),
(3, 'Retur Penjualan', 'Keterangan disini');
...
INSERT INTO `customers` (`id_customer`, `name`, `address`, `phone`, `created_date`, `created_by`, `jenis_pembayaran`) VALUES
(3, 'Oejho', 'Jl. Kampung Utan No. 30, lebak bulus', 628123456788, '2018-06-24', 'admin', '1 Bulan'),
(4, 'PT Gudang Garam', 'jalan taman nusa bakti blok a nomor 12 ', 21, '2018-06-30', 'admin', '1 Minggu'),
(5, 'PT Modera', 'Jalan kamal raya blok b ', 5555559, '2018-07-01', 'admin', '1 Bulan'),
(6, 'toko selaras', 'jalan muara karang blok g nomor 12', 54566714, '2018-07-01', 'admin', '1 Minggu'),
(7, 'Mr NN', 'NN', 876716763, '2018-08-06', 'admin', '1 Bulan');
...
(1, 'Buku gambar', 14000, 20000, 1000, 220, 780, '2018-07-01', 'Buku Gambar'),
(2, 'Meja', 200000, 250000, 100, 44, 56, '2018-06-29', 'Meja lipat @unit'),
(3, 'Payung', 40000, 55000, 500, 300, 200, '2018-06-28', '@pcs'),
...
INSERT INTO `jurnal` (`id_jurnal`, `id_transaksi`, `tgl_jurnal`, `kode_akun`, `debit`, `kredit`) VALUES
(1, 28, '2018-08-05', 1, 5500000, 0),
(2, 28, '2018-08-05', 2, 0, 5500000),
(4, 30, '2018-08-05', 1, 2750000, 0),
(5, 30, '2018-08-05', 2, 0, 2750000),
(6, 28, '2018-08-05', 1, 0, -5500000),
(7, 28, '2018-08-05', 3, -5500000, 0),
(8, 30, '2018-08-05', 1, 0, 2750000),
(9, 30, '2018-08-05', 3, 2750000, 0),
(10, 31, '2018-08-06', 1, 400000, 0),
(11, 31, '2018-08-06', 2, 0, 400000),
(12, 31, '2018-08-06', 3, 400000, 0),
(13, 31, '2018-08-06', 1, 0, 400000);
...
(19, '2018-07-08', '2018-07-08', 'SJ/019/2018', '2018-07-08', 30, 0, 1, 1, 6, 5, 'Harap konfirmasi sebelum kirim'),
...
(26, '2018-08-03', '2018-08-05', '', '2018-08-03', -2, -500000, 1, 2, 4, 5, 'lagi coba'),
(28, '2018-08-05', '2018-08-06', '', '2018-08-05', -100, -5500000, 1, 3, 4, 5, 'jurnal'),
(30, '2018-08-05', '2018-08-10', '', '2018-08-05', -50, -2750000, 1, 3, 3, 5, 'jurnal new'),
(31, '2018-08-06', '2018-08-08', '', '2018-08-06', -20, -400000, 1, 1, 7, 5, 'buku gambar sesuai product');
...
--
ALTER TABLE `jurnal`
  MODIFY `id_jurnal` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `transaction`
  MODIFY `id_transaction` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
